...
$(function() {
	...
	$('.sharing-buttons').html('<div class="button-centered">'+
		'<a href="http://twitter.com/?status='+ url +'" class="button-icon squared flat soft-blue anm-scaleUp delay-800" target="blank" title="Comparteix">Tw</a><br class="hidden-phone">'+
		'<a href="http://www.facebook.com/sharer.php?u='+ url +'&t=title" class="button-icon squared flat blue anm-scaleUp delay-900" target="blank" title="Comparteix">Fb</a><br class="hidden-phone">'+
		'<a href="https://plusone.google.com/_/+1/confirm?hl=en&url='+ url +'" class="button-icon squared flat soft-red anm-scaleUp delay-1000" target="blank" title="Comparteix">G +</a><br class="hidden-phone">'+
	'</div>');
